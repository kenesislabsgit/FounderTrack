...
import { Button, Card, CardContent, Skeleton, Chip, ChipLabel } from '@heroui/react';
            ...
            <div key={leave.id} className="rounded-xl glass p-5 flex items-center gap-4 animate-slide-up-fade">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <Chip className={`${statusColors[leave.status]} rounded-full`}>
                    <ChipLabel className="text-[10px] font-bold uppercase">{leave.status}</ChipLabel>
                  </Chip>
                  <Chip className="bg-[hsl(var(--bg-elevated))] rounded-full">
                    <ChipLabel className="text-[10px] font-bold uppercase text-[hsl(var(--text-muted))]">
              ...
              {isAdmin && leave.status === 'pending' && (
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className="bg-gradient-to-b from-[hsl(145,70%,50%)] to-[hsl(145,70%,42%)]"
                  >
                    <Check size={14} />
                  </Button>
                  <Button

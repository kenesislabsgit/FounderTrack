...
export const LoaderThree = () => {
  return (
    <motion.svg
      ...
      className="h-20 w-20 stroke-amber-500 [--fill-final:var(--color-amber-300)] [--fill-initial:transparent] dark:stroke-amber-400 dark:[--fill-final:var(--color-amber-500)]"
    >
